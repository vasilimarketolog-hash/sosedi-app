...
export const currentUser: User = {
  ...
  bio: 'Живу во 2-м подъезде. Увлекаюсь велопрогулками и благоустройством двора.',
...
export const initialMasters: MasterService[] = [
  {
    ...
    address: 'ул. Леонардо да Винчи, 2, Подъезд 1 (твой сосед!)',
    phone: '+375 (29) 123-45-67',
    priceStarting: 'от 35 Br',
    description: 'Сертифицированный сантехник с опытом 12 лет. Проживаю в Новой Боровой. Установка смесителей, фильтров очистки воды, замена разводки, сборка душевых кабин. Быстрый выезд при протечках 24/7.',
    skills: ['Установка фильтров', 'Замена смесителя', 'Разводка Rehau', 'Аварийный выезд'],
    badges: ['Сосед с 1-го подъезда', 'Топ по отзывам', 'Гарантия 1 год'],
  },
  {
    id: 'mast_2',
    name: 'Владимир Орлов',
    ...
    reviewsCount: 38,
    verifiedNeighbor: true,
    address: 'ул. Леонардо да Винчи, 4, Подъезд 3',
    phone: '+375 (29) 555-77-88',
    priceStarting: 'от 40 Br',
    description: 'Инженер-электрик 5-го разряда. Монтаж розеток, сборка электрощитов, настройка умных выключателей Яндекс / Aqara. Работаю аккуратно, со своим пылесосом.',
  ...
  },
  {
    ...
    reviewsCount: 29,
    verifiedNeighbor: true,
    address: 'ул. Леонардо да Винчи, 2, Подъезд 3, кв. 84',
    phone: '+375 (29) 444-22-11',
    priceStarting: 'от 45 Br / час',
    description: 'Учитель высшей категории, опыт 9 лет (C1 Advanced). Занятия для школьников (1–11 классы), подготовка к ЦТ/ЦЭ. Занятия прямо у меня дома в 3-м подъезде или у вас!',
    skills: ['Подготовка к ЦТ/ЦЭ', 'Разговорный английский', 'Помощь с Д/З'],
    badges: ['Диплом МГЛУ', 'Пешая доступность'],
  },
  {
    id: 'mast_4',
    ...
    reviewsCount: 19,
    verifiedNeighbor: true,
    address: 'ул. Авиационная, 8, Подъезд 2',
    phone: '+375 (29) 999-00-11',
    priceStarting: 'от 20 Br / выгул',
    description: 'Обожаю животных! Проведу активную прогулку с вашей собакой в парке Новой Боровой, покормлю котика во время отпуска. Отправляю фото/видео отчеты.',
...
export const initialMapMarkers: MapMarker[] = [
  {
    ...
    lat: 53.9615,
    lng: 27.7018,
    description: 'Плановые работы ТСЖ с 9:00 до 20:00.',
    author: 'ТСЖ «Новая Боровая»',
    date: '15 августа',
  },
  {
    id: 'mark_2',
    ...
    lat: 53.9622,
    lng: 27.7025,
    description: 'Сбор инициативной группы у центральной клумбы двора да Винчи, 2.',
  ...
  },
  {
    ...
    lat: 53.9608,
    lng: 27.7005,
    description: 'Самовывоз из 3-го подъезда дома ул. Леонардо да Винчи, 2.',
  ...
  },
  {
    ...
    lat: 53.9618,
    lng: 27.7011,
    description: 'Убежал возле 2-го подъезда. Рыжий, синий ошейник. Звоните!',
    author: 'Игорь Мельников (Подъезд 2)',
    date: 'Срочно',
  },
  {
    id: 'mark_5',
    title: '🎃 Свежие яблоки и тыквы с дачи',
    type: 'harvest',
    lat: 53.9625,
    lng: 27.7032,
    description: 'Чистый урожай! Тыквы по 3 Br/кг, яблоки Белый Налив. Самовывоз из 1-го подъезда.',
  ...
  },
  {
    ...
    lat: 53.9614,
    lng: 27.7016,
    description: 'Проживает в доме 2. Готов к срочным вызовам.',
  ...
  },
  {
    ...
    lat: 53.9620,
    lng: 27.7028,
    description: 'Скидка 15% для жителей Новой Боровой по кодовому слову «Соседи».',
    author: 'Партнёр ЖК',
  }
];
...
export const initialHouseChats: HouseChat[] = [
  {
    id: 'chat_house',
    name: '🏢 Общий чат дома (да Винчи, 2)',
    description: 'Официальный чат жителей дома по ул. Леонардо да Винчи, 2. Вопросы ТСЖ, парковка, объявления.',
    icon: 'Building2',
    membersCount: 142,
    unreadCount: 0,
    type: 'house',
